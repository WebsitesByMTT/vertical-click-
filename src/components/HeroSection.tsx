...
const HeroSection = ({
  ...
  return (
    <section className="mx-auto flex h-[60vh] w-full flex-col items-center justify-center">
      ...
      <h2 className="mt-4 text-center text-3xl font-bold uppercase md:mt-10 md:text-5xl xl:text-7xl">
        {subtitle}
      </h2>
      <h2 className="mb-4 rounded-md bg-[#F05186] px-2 text-center text-3xl font-bold text-white uppercase md:mb-10 md:text-5xl xl:text-7xl">
        {pinkBgText}
      </h2>
      {description && (
