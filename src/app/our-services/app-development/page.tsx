...
const TextCardArr = [
  {
    ...
    upperText:
      "We create custom mobile applications that offer seamless user experiences and innovative features to enhance your business operations.",
    checkList: [
    ...
    bottomText:
      "Our apps are designed to engage users, boost customer retention, and enhance brand value.",
  },
  {
    headerText: "Android App Development",
    upperText:
      "Reach a wider audience with feature-packed Android applications that perform across all devices.",
    checkList: [
    ...
    bottomText:
      "Our Android apps are designed for optimal performance, security, and user engagement.",
  },
  {
  ...
  },
  {
    headerText: "Cross-Platform App Development",
    upperText:
      "Save time and cost with cross-platform apps that work seamlessly on both iOS and Android devices.",
    checkList: [
    ...
    bottomText:
      "Cross-platform apps ensure maximum reach with reduced development time and cost.",
  },
  {
    headerText: "Enterprise App Development",
    upperText:
      "Enhance business efficiency with custom enterprise apps tailored to your operational needs.",
    checkList: [
    ...
    bottomText:
      "Our enterprise solutions help businesses streamline workflows and improve productivity.",
  },
  {
    headerText: "E-Commerce App Development",
    upperText:
      "Boost online sales with a custom e-commerce mobile app designed for seamless shopping experiences.",
    checkList: [
    ...
    bottomText:
      "We develop secure and engaging e-commerce apps that increase customer retention and sales.",
  },
  {
    headerText: "App Maintenance & Support",
    upperText:
      "We provide ongoing support to ensure your app runs smoothly and stays updated.",
    checkList: [
    ...
    bottomText:
      "With our comprehensive app maintenance services, your app will stay ahead of the competition.",
  },
];
        ...
        <main className="">
          ...
          <section className="rounded-md bg-black p-8 text-white md:p-14">
            ...
            <p className="mt-5 text-lg font-normal">
              ✔ Custom Solutions – Tailored app development to meet your unique
              business needs. <br />
              ✔ User-Friendly Design – Intuitive UI/UX for enhanced customer
              engagement. <br />
              ✔ Scalable & Secure – Apps built for growth with top security
              standards.
              <br />
              ✔ Seamless Performance – Fast, smooth, and highly responsive
              applications.
              <br />
