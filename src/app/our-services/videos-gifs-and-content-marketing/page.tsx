        ...
        <div className='grid grid-cols-2 md:grid-cols-2 gap-4 mx-auto'>
                        {
                            videoCardItems.map((item, index) => {
                                return (
                                    <div key={index} className='pt-4 flex flex-col justify-between px-4 mt-4 bg-[#fdeaf0]  rounded-lg'>
                                        <div>
                                            <h3 className='text-3xl font-semibold'  dangerouslySetInnerHTML={{ __html: item.title.toUpperCase() }}/>
                                            <p className=' text-xl text-gray-800 font-sans pt-4' dangerouslySetInnerHTML={{ __html: item.msg }} />

                                        </div>
                                        <div className='relative  '>
                                            <div className='absolute left-[40%] top-[50%] flex flex-col gap-1 mb-2 p-4 bg-[#8F5BFE] shadow-md rounded-lg'>
                                                <h4 className='text-white font-semibold text-md'>{item.subtitle}</h4>
                                            ...
                                            <div>
                                                <img src={item.img} width={100} alt="" className=' md:w-75 ml-auto' />
