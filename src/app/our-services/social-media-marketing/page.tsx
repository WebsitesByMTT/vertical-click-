...
const SMM = () => {
  return (
    <main>
      ...
      <Divider />
      <section className="max-w-[90vw] md:max-w-[70vw] mx-auto bg-black text-white rounded-4xl p-14">
        ...
        <ul className="list-disc pl-6 mt-4 text-lg md:text-xl font-normal space-y-2">
          <li>
      ...
      <section className="max-w-[90vw] md:max-w-[70vw] mx-auto">
        <h1 className="text-4xl md:text-5xl font-medium uppercase mb-4">
          Key Highlights
        </h1>
