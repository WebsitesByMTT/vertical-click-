...
export default function Home() {
  return (
    <div>
      ...
      {/* hero */}
      <Container>
        <div className=" flex justify-center items-center h-[50vh] lg:h-screen">
        ...
        <div className=" mx-auto space-y-6 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center w-full">
            ...
            <div className="md:w-1/2 flex flex-col justify-between items-start h-full text-start ">
              ...
              <p className="text-xl">
                In a world where digital connections are omnipresent, we
                recognize the importance of a unified approach to digital
                communications. Our solution integrates creative vision,
                technical prowess, and a diverse array of digital marketing
                disciplines.
              </p>
              {/* <Link
              className="bg-gradient-to-r from-[#F05186] to-[#8F5BFE] text-white px-4 py-2 rounded-md inline-flex items-center gap-2 w-fit mt-4"
        ...
        <Divider />
        {/* why us */}
        <section className="  bg-black text-white rounded-md">
