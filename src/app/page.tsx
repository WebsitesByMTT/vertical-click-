    ...
    <div>
      ...
      <div className="max-w-[70vw] mx-auto space-y-6">
        ...
        <div className="container flex justify-center items-center w-full">
          ...
          <div className="w-1/2">
            <h1 className="text-5xl font-bold uppercase text-[#8F5BFE] content-start inline-block py-2 ">
      ...
      <div className="max-w-[70vw] mx-auto space-y-6 flex flex-col justify-center items-center w-full">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="bg-[#F05186] rounded-3xl p-8 group hover:scale-[1.02] transition-all duration-300 cursor-pointer relative overflow-hidden">
      ...
      <section className="max-w-[70vw] mx-auto">
        <div className="max-full mx-auto">
          <h2 className="text-6xl font-bold text-center mb-16">BLOGS</h2>
