      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {posts?.edges?.map((post: any, index: number) => ( 
            <div key={index} className="px-4 py-4 my-4 md:my-8 flex flex-col md:flex-row items-center gap-4 border border-purple-600 shadow-2xl rounded-md bg-gradient-to-b from-white to-violet-400">
                  <img 
